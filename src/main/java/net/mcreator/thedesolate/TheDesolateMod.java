...
import net.mcreator.thedesolate.init.TheDesolateModBlocks;
...
@Mod("the_desolate")
public class TheDesolateMod {
	public static final Logger LOGGER = LogManager.getLogger(TheDesolateMod.class);
	public static final String MODID = "the_desolate";

	public TheDesolateMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		TheDesolateModBlocks.REGISTRY.register(modEventBus);
